...
(defonce date-atom (atom {:left  {:year  {:play-mode false :play-mode-before-sliding false :value 2017 :min 1951 :max 2100}
                                  :month {:play-mode false :play-mode-before-sliding false :value 1 :min 1 :max 12}}
                          :right {:year  {:play-mode false :play-mode-before-sliding false :value 2017 :min 1951 :max 2100}
                                  :month {:play-mode false :play-mode-before-sliding false :value 1 :min 1 :max 12}}}))
